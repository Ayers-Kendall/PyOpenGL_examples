...
class ObjLoader:
    ...
    @staticmethod
    def search_data(data_values, coordinates, skip, data_type, scale=1.0):
    ...
    @staticmethod
    def load_model(file, sorted=True, scale=1.0):
        ...
        with open(file, 'r') as f:
            ...
            while line:
                values = line.split()
                if values[0] == 'v':
                    ObjLoader.search_data(values, vert_coords, 'v', 'float', scale)
                elif values[0] == 'vt':
